...
function e() {
  a[1] && ((this.src = a[1]), (this.onerror = null)),
    ...
    uni.postMessage({
      data: { action: "onError", source: "img", attrs: t(this) },
    });
}
function n() {
  (window.unloadimgs -= 1),
    0 === window.unloadimgs && uni.postMessage({ data: { action: "onReady" } });
}
function o(r, s, c) {
        ...
        if ((u.children && o(u.children, l, c), "img" === g)) {
          if (
            ...
            u.attrs.ignore ||
              (l.onclick = function (e) {
                e.stopPropagation(),
                  uni.postMessage({
                    data: { action: "onImgTap", attrs: t(this) },
                  });
              }),
            a[2])
          ) {
          ...
          l.addEventListener(
            ...
            function (e) {
              ...
              o &&
                "#" === o[0] &&
                (n = (document.getElementById(o.substr(1)) || {}).offsetTop),
                uni.postMessage({
                  data: { action: "onLinkTap", attrs: t(this), offset: n },
                });
            },
            !0,
          );
          ...
          i.push(l),
            ...
            (l.onerror = function () {
              uni.postMessage({
                data: { action: "onError", source: g, attrs: t(this) },
              });
            });
...
(window.setContent = function (t, e, n) {
  ...
  uni.postMessage({ data: { action: "onLoad", height: c } }),
    window.unloadimgs ||
      uni.postMessage({ data: { action: "onReady", height: c } }),
    clearInterval(window.timer),
    (window.timer = setInterval(function () {
      r.scrollHeight !== c &&
        ((c = r.scrollHeight),
        uni.postMessage({ data: { action: "onHeightChange", height: c } }));
    }, 350));
}),
