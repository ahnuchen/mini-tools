<template>
  <view>
    <view class="my-info">
      <text class="my-text"
        >2010年第六次全国人口普查，我国人口平均预期寿命大约75岁，也就是900个月，我们用以下30x30的格子来代表人的一生，看看我们一生的时间吧
      </text>
    </view>
    <view class="page-container">
      ...
      <canvas
        ...
        class="my-canvas"
        :style="'width: ' + l1 + 'px; height: ' + l1 + 'px;'"
      ></canvas>
    </view>
...
export default {
  ...
  methods: {
    drawGrid: function (t) {
      ...
      for (
        n.setStrokeStyle("#999"), n.strokeRect(0, 0, i, i), a = 0;
        a < 30;
        a++
      ) {
        for (s = 0; s < 30; s++) {
      ...
      if (s > n || (s == n && o > a)) {
        ...
        i
          ? (this.currentNum || (this.currentNum = 0),
            (this.monthNum = h),
            this.isAnimating || this.drawGridWithAnim())
          : ((this.monthNum = this.currentNum = h), this.drawGrid(h));
        this.setData({
          l4: t,
