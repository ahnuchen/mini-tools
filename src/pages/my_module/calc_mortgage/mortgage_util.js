...
const truncate = (num, decimal = 2) => {
  var numStr = (num * 1).toFixed(decimal + 1);
...
const businessRateDiscountArr = [
  0.7, 0.8, 0.83, 0.85, 0.9, 0.95, 1, 1.05, 1.1, 1.15, 1.2, 1.25, 1.3, 1.35,
  1.4,
];
/**
 * 获取当前商业利率波动
...
const getBusinessLoanRateArr = (year) => {
  ...
  for (var discount of businessRateDiscountArr) {
    ...
    let rateValue = ((baseRate * intDiscount) / 1000).toLocaleString();
    let rateText = "";
    if (discount < 1) {
